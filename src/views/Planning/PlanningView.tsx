...
import { unplannedGridConfig } from "./partials/UnplannedGridConfig";
import { isSameDay } from "date-fns";
import { Grid } from "@bryntum/grid-thin";
import { Drag } from "./partials/Drag";
import MapPanel from "./partials/MapPanel";
import { SlideToggle } from "@bryntum/core-thin";
import MetricCard, { MetricCardProps } from "./partials/MetricCard";
...
} from "views/Planning/renderers/eventRenderers";
import {
  basicDriverRenderer,
  detailedDriverRenderer,
} from "views/Planning/renderers/driverRenderers";
...
const PlanningView = () => {
  ...
  const schedulerConfig: BryntumSchedulerProProps = {
    ...
    onDependencyCreateDrop: ({ source, target, dependency }) => {
      dependency.set(
        "lag",
        (source.getData("postambleInMinutes") +
          target.getData("preambleInMinutes")) /
          (24 * 60)
      );
    },
